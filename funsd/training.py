...
import numpy as np
from datasets import Dataset,load_dataset, load_metric, Features, Sequence, ClassLabel, Value, Array2D, Array3D
...
dataset = load_dataset("mp-02/funsd")
...
training_args = TrainingArguments(output_dir="layoutlmv3-finetuned-funsd2",
                                  max_steps=120,
                                  per_device_train_batch_size=7,
                                  per_device_eval_batch_size=7,
                                  push_to_hub=True,
                                  hub_model_id="mp-02/layoutlmv3-finetuned-funsd2",
                                  learning_rate=1e-5,
                                  eval_strategy="steps",
                                  eval_steps=10,
...
kwargs["dataset_tags"] = "mp-02/funsd"
kwargs["dataset"] = "mp-02/funsd"

trainer.push_to_hub("mp-02/layoutlmv3-finetuned-funsd2")