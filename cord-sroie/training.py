...
training_args = TrainingArguments(output_dir="layoutlmv3-base-cord-sroie",
                                  max_steps=4000,
                                  per_device_train_batch_size=8,
                                  per_device_eval_batch_size=8,
                                  push_to_hub=True,
                                  push_to_hub_model_id=f"layoutlmv3-base-cord-sroie",
                                  learning_rate=2e-5,
...
kwargs["dataset_tags"] = "mp-02/cord-sroie"
kwargs["dataset"] = "mp-02/cord-sroie"
